...
class Facturaxion implements ProviderInterface
{
    ...
    const WS_PRODUCTION = 'https://www.factureyapac.com/WSTimbrado33/WSCFDI33.svc?WSDL';
    //const WS_DEVELOPMENT = 'https://wstimbradopruebas.facturaxion.com/WSTimbrado.svc?singleWsdl';
    const WS_DEVELOPMENT = 'https://app.factureyapac.com/WSTimbrado33Test/WSCFDI33.svc?WSDL';

    /** @var FacturaYaSettings */
    private $settings;

    /** @var \PhpCfdi\Timbrado\Soap\SoapClientInterface */
    private $soapClient;

    public function __construct(FactureYaSettings $settings, SoapClientInterface $soapClient = null)
    {
